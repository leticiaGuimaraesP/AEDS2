...
public class TP3EX1 {
    ...
    public static void main(String args[]) throws FileNotFoundException{
        ...
        listaDeGame.ordenacaoPorSelecao();     
...
class Lista{
    ...
    /**
	 * Ordena a lista de Game por meio do método de Seleção, utilizando
	 * como chave o atributo Name
	 */
    public void ordenacaoPorSelecao(){
         ...
         for(int i=0; i<(n-1); i++){
            int menor = i;
            for(int j=(i+1); j<n; j++){
                int result = array[menor].getName().compareTo(array[j].getName()); 
                if(result>0){
                    menor=j;
                }
            }

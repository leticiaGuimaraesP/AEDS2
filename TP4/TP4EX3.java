...
public class TP4EX3 {
    ...
    public static void main(String[] args) throws Exception{
       //Leitura da primeira parte da entrada
        ...
        CFila filaDeGame = new CFila(); //criação da lista
        int index = 0;
        String app_id;
        ...
        filaDeGame.mostra(); //impressão dos elementos da lista
    }
}
...
class CFila {
	 ...
	 */
	public void enfileira(Game valorItem) {
    ...
    public int retornaAvgPt(){
        return frente.item.getAvgPlaytime();
    }
